...
while 1: #repeat forever
    ...
    difference = abs(input["ratio"] - 0.01) #calculate the difference
    t = time.time()
    print json.dumps({"number":input["number"], "difference in the ratio":difference,"actual ratio":input["ratio"],"time":t}) #print in JSON format the difference in ratios, actual ratio and timestamp at which it was obtained
